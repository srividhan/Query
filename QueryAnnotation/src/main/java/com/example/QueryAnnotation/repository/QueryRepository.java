package com.example.QueryAnnotation.repository;
...
public interface QueryRepository extends JpaRepository<Queries, Long>{
    ...
    List<Queries> findData(@Param("activeState") Boolean activeState, @Param("descriptionList") List<String> discriptionList);
    @Modifying
